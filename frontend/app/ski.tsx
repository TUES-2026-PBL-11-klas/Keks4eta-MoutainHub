...
const POSTS = [
  {
    ...
    subtitle: "Bansko • 7.2 km • Medium",
    photos: [require("@/assets/images/image mountain horizontal.jpg"), require("@/assets/images/image.png")],
  },
  {
    id: "s2",
    user: "Elena Dimitrova",
    title: "added a new trail",
    subtitle: "Rila • 10.4 km • Hard",
    photos: [require("@/assets/images/image.png")],
  },
];

const MAP_ACTIVITY = [
  { id: "m1", title: "New ski route published", place: "Pirin (BG)" },
  { id: "m2", title: "Avalanche warning updated", place: "Rila (BG)" },
  { id: "m3", title: "Trail reopened", place: "Vitosha (BG)" },
];

export default function SkiHome() {
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.pageTitle}>Ski Trail</Text>
          ...
          <View style={styles.sportBanner}>
            <Ionicons name="snow-outline" size={20} color={COLORS.primaryText} />
            <Text style={styles.sportBannerText}>
              Sport image missing: add `assets/photos/ski.*` and I’ll wire it here.
            </Text>
          </View>
        </ScrollView>
      </ImageBackground>
...
function createStyles(isCompact: boolean) {
  return StyleSheet.create({
    ...
    userDot: { width: 14, height: 14, borderRadius: 999, backgroundColor: COLORS.blue },
