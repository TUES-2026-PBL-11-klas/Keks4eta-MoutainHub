...
const POSTS: FeedPost[] = [
  {
    ...
    subtitle: "Balkan Mountains • 18.4 km • Hard",
    photos: [require("@/assets/images/image.png"), require("@/assets/images/image mountain horizontal.jpg")],
  },
  {
    id: "b2",
    userId: "u5",
    ...
    subtitle: "Rhodope • 14.0 km • Medium",
    photos: [require("@/assets/images/image mountain horizontal.jpg")],
  },
];

const MAP_ACTIVITY = [
  { id: "m1", title: "New MTB trail published", place: "Rhodope Mountains (BG)" },
  { id: "m2", title: "Trail difficulty updated", place: "Balkan Mountains (BG)" },
  { id: "m3", title: "Trail closed (maintenance)", place: "Vitosha (BG)" },
];

export default function MtbHome() {
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.pageTitle}>MTB Trail</Text>
          ...
          <View style={styles.sportBanner}>
            <Ionicons name="bicycle-outline" size={20} color={COLORS.primaryText} />
            <Text style={styles.sportBannerText}>
              Sport image missing: add `assets/photos/mtb.*` and I’ll wire it here.
            </Text>
          </View>
        </ScrollView>
      </ImageBackground>
...
function createStyles(isCompact: boolean) {
  return StyleSheet.create({
    ...
    userDot: { width: 14, height: 14, borderRadius: 999, backgroundColor: COLORS.brown },
